...
import org.zhu.enums.ListSortEnum;
import org.zhu.enums.PriceCompareEnum;
import org.zhu.mapper.ProductMapper;
...
public class ProductTool {
    ...
    // 新增一个商品，商品名称是耐克帽子，价格是99元，预售状态，库存有299
    // 新增一个商品，商品名称是创世神机箱，品牌是败家之眼，价格是2999元，上架状态，库存有888
    // 查询所有的商品
    // 查询价格不高于1299的商品
    // 查询鞋子和帽子，以及价格小于2000的商品
    // 修改商品编号为272593506828的商品，把商品名称改成太阳神机箱，价格1999，库存777，下架
}
